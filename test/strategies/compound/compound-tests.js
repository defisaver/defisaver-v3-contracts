...
const compV2BoostTest = () =>
    describe('Comp-Boost-Strategy', function () {
        ...
        for (let i = 0; i < testPairs.length; i++) {
            ...
            it('... should make a new Comp position and sub', async () => {
                ...
                await borrowComp(proxy, cDebtAsset.address, debtAmount, senderAcc.address);
...
const compV2RepayTest = () =>
    describe('Comp-Repay-Strategy', function () {
        this.timeout(1000000);
