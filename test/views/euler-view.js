...
const { takeSnapshot, revertToSnapshot, getOwnerAddr, redeploy } = require('../utils/utils');
    ...
    describe('EulerV2-View', function () {
        ...
        before(async () => {
            ...
            if (isFork) {
                ...
                viewContract = await hre.ethers.getContractAt(
                    'EulerV2View',
                    '0x561013c605A17f5dC5b738C8a3fF9c5F33DbC3d8',
                );
            } else {
        ...
        it('...test view calls', async () => {
            ...
            const userData = await viewContract.getUserData(
                '0x1e17A75616cd74f5846B1b71622Aa8e10ea26Cc0',
            );
            console.log(userData);
            const accounts = await viewContract.fetchUsedAccounts(
                '0x99fd78c210b3Dec66607d2235784C3f9512cb1C9',
                8,
                30,
            );
