...
contract PriceFeedRegistry is AdminAuth {
    ...
    function getFeed(address base, address quote) public view returns (address aggregator) {
    ...
    function setFeed(address base, address quote, address aggregator) public onlyOwner {
