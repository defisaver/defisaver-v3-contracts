...
library DFSIds {
    ...
    bytes4 internal constant DEFISAVER_CONNECTOR = bytes4(keccak256("DefiSaverConnector"));
    ...
    bytes4 internal constant CURVE_TRANSIENT_SWAPPER = bytes4(keccak256("CurveUsdSwapperTransient"));
}
