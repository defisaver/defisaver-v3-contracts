...
contract MorphoAaveV3LSVSupply is ActionBase, MorphoAaveV3Helper, MorphoAaveV3LSVHelper {
    ...
    function _supply(Params memory _params) internal returns (uint256, bytes memory) {
        ...
        if (_params.supplyAsColl) {
            ...
            ILSVProfitTracker(profitTrackerAddr).supply(_params.tokenAddr, _params.amount);
        }
