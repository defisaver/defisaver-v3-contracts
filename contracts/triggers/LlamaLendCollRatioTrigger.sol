...
/// @title Trigger contract that verifies if the Llamalend position went over/under the subbed ratio
contract LlamaLendUsdCollRatioTrigger is ITrigger, AdminAuth, LlamaLendHelper, TriggerHelper {
    ...
    /// @param market Llamalend controller address
    ...
    /// @dev checks current safety ratio of a Llamalend position and triggers if it's in a correct state
    ...
    {   
        ...
        tempStorage.setBytes32("LLAMALEND_RATIO", bytes32(currRatio));
