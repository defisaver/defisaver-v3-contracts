...
library LogarithmicBuckets {
    ...
    function update(Buckets storage _buckets, address _id, uint256 _newValue, bool _head) internal {
    ...
    function nextBucket(uint256 lowerMask, uint256 bucketsMask) internal pure returns (uint256 bucket) {
        assembly {
