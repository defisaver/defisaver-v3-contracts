...
interface IBundleStorage {
    ...
    function getStrategyId(uint256 _bundleId, uint256 _strategyIndex) external view returns (uint256);
    function getBundle(uint256 _bundleId) external view returns (StrategyModel.StrategyBundle memory);
