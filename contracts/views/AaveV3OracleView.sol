...
contract AaveV3OracleView is AaveV3RatioHelper {
    ...
    function getTimestamp(address _asset, uint256 _roundId)
        external
        view
    ...
    function getNextRoundId(address _asset, uint80 _roundId)
        external
        view
        returns (uint80 nextRoundId)
    {
        ...
        IPhaseAggregator phaseAggregator =
            IPhaseAggregator(aggregatorProxy.phaseAggregators(phaseId));
