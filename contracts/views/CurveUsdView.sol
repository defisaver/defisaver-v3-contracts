...
contract CurveUsdView is CurveUsdHelper {
    ...
    function createLoanData(address market, uint256 collateral, uint256 debt, uint256 N)
        external
        view
    ...
    function getBandsDataForPosition(address market, uint256 collateral, uint256 debt, uint256 N)
        external
        view
        returns (Band[] memory bands)
    {
        ICrvUsdController ctrl = ICrvUsdController(market);
