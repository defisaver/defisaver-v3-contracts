...
contract FLAction is ActionBase, ReentrancyGuard, IFlashLoanBase, FLHelper {
    ...
    function executeOperation(
        ...
        _executeRecipe(wallet, _isDSProxy(wallet), currRecipe, _amounts[0] + _fees[0]);
    ...
    function onFlashLoan(
        ...
        _executeRecipe(wallet, _isDSProxy(wallet), currRecipe, paybackAmount);
        ...
        nonReentrant
    {
        ...
        _executeRecipe(wallet, _isDSProxy(wallet), currRecipe, params.amounts[0]);
    ...
    function onMorphoFlashLoan(uint256 assets, bytes calldata data) external nonReentrant {
        ...
        _executeRecipe(wallet, _isDSProxy(wallet), currRecipe, assets);
