...
/// @title Borrow assets from Fluid Vault T2 (2_col:1_debt)
contract FluidVaultT2Borrow is ActionBase, FluidHelper {
    ...
    function executeActionDirect(bytes memory _callData) public payable override {
        ...
        logger.logActionDirectEvent("FluidVaultT2Borrow", logData);
    }
