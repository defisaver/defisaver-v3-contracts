...
// TODO: Reuse logic from FluidVaultT1Payback later once we have all vaults supports
/// @title Payback debt to Fluid Vault T2 (2_col:1_debt)
contract FluidVaultT2Payback is ActionBase, FluidHelper {
    ...
    function _payback(Params memory _params) internal returns (uint256, bytes memory) {
        ...
        address borrowToken = constants.borrowToken.token0;
        ...
        ( , , int256 exactPaybackAmount) = IFluidVaultT2(_params.vault).operate{value: msgValue}(
            _params.nftId,
            0, /* newColToken0_ */
            0, /* newColToken1_ */
            0, /* colSharesMinMax_ */
