...
contract CompV3Transfer is ActionBase, CompV3Helper {
    ...
    function executeAction(
        ...
        (uint256 withdrawAmount, bytes memory logData) = _transfer(params.from, params.to, params.asset, params.amount);
    ...
    function executeActionDirect(bytes memory _callData) public payable override {
        Params memory params = parseInputs(_callData);
        (, bytes memory logData) = _transfer(params.from, params.to, params.asset, params.amount);
