...
contract CompSubProxy is StrategyModel, AdminAuth, ProxyPermission, CoreHelper {
    ...
    function formatRepaySub(CompSubData memory _subData, address _proxy) public pure returns (StrategySub memory repaySub) {
    ...
    function formatBoostSub(CompSubData memory _subData, address _proxy) public pure returns (StrategySub memory boostSub) {
