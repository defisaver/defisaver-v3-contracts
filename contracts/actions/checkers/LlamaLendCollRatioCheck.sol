...
contract LlamaLendCollRatioCheck is ActionBase, LlamaLendHelper {
    ...
    function executeAction(
        ...
        uint256 startRatio = uint256(tempStorage.getBytes32("LLAMALEND_RATIO"));
        ...
        emit ActionEvent("LlamaLendCollRatioCheck", abi.encode(currRatio));
