...
contract FetchBondIdMulti is ActionBase, CBHelper {
    ...
    struct Params {
        uint256 currentSubId; // piped from sub data
        uint256 ordinalNumberOfSourceId; // backend would send this
        StrategyModel.StrategySub paybackSub; // backend would send this
        uint256 cbRebondBondId; // backend would send this
    }
