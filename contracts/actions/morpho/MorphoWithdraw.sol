...
contract MorphoWithdraw is ActionBase, MorphoHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("MorphoWithdraw", logData);
    ...
    function executeActionDirect(bytes memory _callData) public payable virtual override {
        ...
        logger.logActionDirectEvent("MorphoWithdraw", logData);
    }
    ...
    function _withdraw(Params memory _params) internal returns (uint256, bytes memory) {
        ...
        IMorpho(MORPHO_ADDR).withdraw(aTokenAddress, _params.amount, _params.to);
