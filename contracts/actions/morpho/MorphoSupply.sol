...
contract MorphoSupply is ActionBase, MorphoHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("MorphoSupply", logData);
    ...
    function executeActionDirect(bytes memory _callData) public payable virtual override {
        ...
        logger.logActionDirectEvent("MorphoSupply", logData);
    }
    ...
    function _supply(Params memory _params) internal returns (uint256, bytes memory) {
        ...
        IMorpho(MORPHO_ADDR).supply(aTokenAddress, _params.onBehalf, _params.amount);
