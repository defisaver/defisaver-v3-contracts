...
contract GasFeeTaker is ActionBase, GasFeeHelper {
    ...
    function executeAction(
        ...
        inputData.feeToken = _parseParamAddr(inputData.feeToken, _paramMapping[1], _subData, _returnValues);
        inputData.availableAmount = _parseParamUint(inputData.availableAmount, _paramMapping[2], _subData, _returnValues);
