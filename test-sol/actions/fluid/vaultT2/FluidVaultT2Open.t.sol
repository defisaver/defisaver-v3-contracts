...
// import { FluidDexModel } from "../../../../contracts/actions/fluid/common/dex/FluidDexModel.sol";
...
//     struct TestConfig {
//         FluidDexModel.ShareType shareType;
...
//         FluidDexModel.SupplyExactData shareExactData;
...
//         _baseTest(
//             TestConfig({
//                 shareType: FluidDexModel.ShareType.VARIABLE,
...
//         _baseTest(
//             TestConfig({
//                 shareType: FluidDexModel.ShareType.EXACT,
...
//                 }
//                 if (_config.shareType == FluidDexModel.ShareType.VARIABLE) {
...
//                 if (_config.shareType == FluidDexModel.ShareType.EXACT) {
...
//                     });
//                 } else {
//                     vars.shareExactData = FluidDexModel.SupplyExactData({
