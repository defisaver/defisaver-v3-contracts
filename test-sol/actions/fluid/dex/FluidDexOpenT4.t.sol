...
contract TestFluidDexOpenT4 is FluidTestBase {
    ...
    function _assertCollToken0BalanceChange(
        ...
        if (tokenDelta < 0) {
            assertEq(
                _vars.senderCollToken0BalanceAfter,
                _vars.senderCollToken0BalanceBefore - uint256(-tokenDelta)
            );
        } else {
            assertEq(
                _vars.senderCollToken0BalanceAfter,
    ...
    function _assertCollToken1BalanceChange(
        ...
        if (tokenDelta < 0) {
            assertEq(
                _vars.senderCollToken1BalanceAfter,
                _vars.senderCollToken1BalanceBefore - uint256(-tokenDelta)
            );
        } else {
            assertEq(
                _vars.senderCollToken1BalanceAfter,
    ...
    function _assertBorrowToken0BalanceChange(
        ...
        if (
            ((_vars.isNativeSupply0 || _vars.isNativeSupply1)
                    && _vars.isNativeBorrow0
                    && !_wrapBorrowedEth)
            ...
            assertEq(
                _vars.senderBorrowToken0BalanceAfter,
                _vars.senderBorrowToken0BalanceBefore + _vars.borrowAmount0
            );
        }
    }
    ...
    function _assertBorrowToken1BalanceChange(
        ...
        if (
            ((_vars.isNativeSupply1 || _vars.isNativeSupply0)
                    && _vars.isNativeBorrow1
                    && !_wrapBorrowedEth)
                || (!_vars.isNativeSupply1
                    && !_vars.isNativeSupply0
            ...
            assertEq(
                _vars.senderBorrowToken1BalanceAfter,
                _vars.senderBorrowToken1BalanceBefore + _vars.borrowAmount1
            );
        }
    }
}
