...
contract ActionsUtils {
    ...
    function aaveV3RatioCheckEncode(uint8 _state, uint256 _targetRatio) public pure returns (bytes memory) {
        AaveV3RatioCheck.Params memory params =
            AaveV3RatioCheck.Params({ ratioState: AaveV3RatioCheck.RatioState(_state), targetRatio: _targetRatio });
