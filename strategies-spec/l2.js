...
const compV3Actions = {
    ...
    feeTakingAction: (baseToken, amount) =>
        new dfs.actions.basic.GasFeeActionL2(
            '0', // must stay variable backend sets gasCost
...
const createCompV3FLBoostL2Strategy = () => {
    ...
    compV3FlBoostStrategy.addAction(
        compV3Actions.sellAction('&baseToken', '%collToken', '%amount'),
    ); // variable amount from FL
...
const createAaveV3FLOpenOrderFromCollL2Strategy = () => {
    const aaveV3OpenOrderFromCollL2Strategy = new dfs.Strategy(
        'AaveV3FLOpenOrderFromCollL2Strategy',
    );
...
const createMorphoBlueBoostOnTargetPriceL2Strategy = () => {
    const morphoBlueBoostOnTargetPriceStrategy = new dfs.Strategy(
        'MorphoBlueBoostOnTargetPriceL2Strategy',
    );
...
const createMorphoBlueFLBoostOnTargetPriceL2Strategy = () => {
    const morphoBlueFLBoostOnTargetPriceStrategy = new dfs.Strategy(
        'MorphoBlueFLBoostOnTargetPriceL2Strategy',
    );
...
const createAaveV3GenericBoostOnPriceL2Strategy = () => {
    const aaveV3GenericBoostOnPriceL2Strategy = new dfs.Strategy(
        'AaveV3GenericBoostOnPriceL2Strategy',
    );
...
const createAaveV3GenericFLBoostOnPriceL2Strategy = () => {
    const aaveV3GenericFLBoostOnPriceL2Strategy = new dfs.Strategy(
        'AaveV3GenericFLBoostOnPriceL2Strategy',
    );
...
const createAaveV3GenericRepayOnPriceL2Strategy = () => {
    const aaveV3GenericRepayOnPriceL2Strategy = new dfs.Strategy(
        'AaveV3GenericRepayOnPriceL2Strategy',
    );
...
const createAaveV3GenericFLRepayOnPriceL2Strategy = () => {
    const aaveV3GenericFLRepayOnPriceL2Strategy = new dfs.Strategy(
        'AaveV3GenericFLRepayOnPriceL2Strategy',
    );
    ...
    aaveV3GenericFLRepayOnPriceL2Strategy.addAction(flAction);
...
const createAaveV3GenericFLCloseToCollL2Strategy = () => {
    const aaveV3GenericFLCloseToCollL2Strategy = new dfs.Strategy(
        'AaveV3GenericFLCloseToCollL2Strategy',
    );
    ...
    aaveV3GenericFLCloseToCollL2Strategy.addSubSlot(
    ...
    aaveV3GenericFLCloseToCollL2Strategy.addAction(sendTokenToFLAction);
...
const createAaveV3GenericFLCloseToDebtL2Strategy = () => {
    const aaveV3GenericFLCloseToDebtL2Strategy = new dfs.Strategy(
        'AaveV3GenericFLCloseToDebtL2Strategy',
    );
    ...
    aaveV3GenericFLCloseToDebtL2Strategy.addSubSlot(
        '&automationSdk.enums.CloseStrategyType',
        'uint8',
    ); // only used by backend to determine which action to call
    ...
    aaveV3GenericFLCloseToDebtL2Strategy.addAction(sendTokenToFLAction);
    aaveV3GenericFLCloseToDebtL2Strategy.addAction(sendTokenToEOA);
...
const createMorphoBlueFLCloseToCollL2Strategy = () => {
    ...
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&loanToken', 'address');
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&collateralToken', 'address');
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&oracle', 'address');
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&irm', 'address');
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&lltv', 'uint256');
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&user', 'address');
    morphoBlueFLCloseToCollL2Strategy.addSubSlot('&automationSdk.enums.CloseStrategyType', 'uint8'); // only used by backend to determine which action to call
    ...
    morphoBlueFLCloseToCollL2Strategy.addTrigger(trigger);
    ...
    morphoBlueFLCloseToCollL2Strategy.addAction(flAction);
    morphoBlueFLCloseToCollL2Strategy.addAction(sellAction);
    morphoBlueFLCloseToCollL2Strategy.addAction(morphoPayback);
    morphoBlueFLCloseToCollL2Strategy.addAction(morphoWithdrawCollateral);
    morphoBlueFLCloseToCollL2Strategy.addAction(feeTakingAction);
    morphoBlueFLCloseToCollL2Strategy.addAction(sendTokenToFlAction);
    morphoBlueFLCloseToCollL2Strategy.addAction(sendTokensAction);

    return morphoBlueFLCloseToCollL2Strategy.encodeForDsProxyCall();
};

const createMorphoBlueFLCloseToDebtL2Strategy = () => {
    const morphoBlueFLCloseToDebtL2Strategy = new dfs.Strategy('MorphoBlueFLCloseToDebtL2Strategy');

    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&loanToken', 'address');
    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&collateralToken', 'address');
    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&oracle', 'address');
    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&irm', 'address');
    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&lltv', 'uint256');
    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&user', 'address');
    morphoBlueFLCloseToDebtL2Strategy.addSubSlot('&automationSdk.enums.CloseStrategyType', 'uint8'); // only used by backend to determine which action to call
    ...
    morphoBlueFLCloseToDebtL2Strategy.addTrigger(trigger);
    ...
    morphoBlueFLCloseToDebtL2Strategy.addAction(flAction);
    morphoBlueFLCloseToDebtL2Strategy.addAction(morphoPayback);
    morphoBlueFLCloseToDebtL2Strategy.addAction(morphoWithdrawCollateral);
    morphoBlueFLCloseToDebtL2Strategy.addAction(sellAction);
    morphoBlueFLCloseToDebtL2Strategy.addAction(feeTakingAction);
    morphoBlueFLCloseToDebtL2Strategy.addAction(sendTokenToFlAction);
    morphoBlueFLCloseToDebtL2Strategy.addAction(sendTokenToEoaAction);
...
const createFluidT1LiquidationProtectionL2Strategy = () => {
    const fluidT1LiquidationProtectionStrategy = new dfs.Strategy(
        'FluidT1LiquidationProtectionL2Strategy',
    );
...
const createFluidT1FLLiquidationProtectionL2Strategy = () => {
    const fluidT1FLLiquidationProtectionStrategy = new dfs.Strategy(
        'FluidT1FLLiquidationProtectionL2Strategy',
    );
...
const createMorphoBlueLiquidationProtectionL2Strategy = () => {
    const morphoBlueLiquidationProtectionStrategy = new dfs.Strategy(
        'MorphoBlueLiquidationProtectionL2Strategy',
    );
    ...
    const withdrawAction = new dfs.actions.morphoblue.MorphoBlueWithdrawCollateralAction(
        ...
        '&irm',
        '&lltv',
        '%LiquidationProtectionAmount', // sent by backend
        '&user',
        '&proxy',
    );
...
const createMorphoBlueFLCollLiquidationProtectionL2Strategy = () => {
    const morphoBlueLiquidationProtectionStrategy = new dfs.Strategy(
        'MorphoBlueFLCollLiquidationProtectionL2Strategy',
    );
    ...
    const sellAction = new dfs.actions.basic.SellAction(
        formatExchangeObj(
            '&collateralToken',
            '&loanToken',
            '%LiquidationProtectionAmount', // same as flamount, sent by backend
            '%exchangeWrapper', // sent by backend
        ),
        '&proxy',
        '&proxy',
    ...
    morphoBlueLiquidationProtectionStrategy.addAction(new dfs.actions.flashloan.FLAction(flAction));
    morphoBlueLiquidationProtectionStrategy.addAction(sellAction);
    morphoBlueLiquidationProtectionStrategy.addAction(feeTakingAction);
    morphoBlueLiquidationProtectionStrategy.addAction(paybackAction);
    morphoBlueLiquidationProtectionStrategy.addAction(withdrawAction);
...
const createMorphoBlueFLDebtLiquidationProtectionL2Strategy = () => {
    const morphoBlueLiquidationProtectionStrategy = new dfs.Strategy(
        'MorphoBlueFLDebtLiquidationProtectionL2Strategy',
    );
    ...
    const paybackAction = new dfs.actions.morphoblue.MorphoBluePaybackAction(
        ...
        '&irm',
        '&lltv',
        '%LiquidationProtectionAmount', // <- same as flAmount
        '&proxy',
        '&user',
    );
    const withdrawAction = new dfs.actions.morphoblue.MorphoBlueWithdrawCollateralAction(
    ...
    morphoBlueLiquidationProtectionStrategy.addAction(sellAction);
    morphoBlueLiquidationProtectionStrategy.addAction(feeTakingAction);
    morphoBlueLiquidationProtectionStrategy.addAction(sendTokensAction);
    morphoBlueLiquidationProtectionStrategy.addAction(morphoBlueRatioCheckAction);
    return morphoBlueLiquidationProtectionStrategy.encodeForDsProxyCall();
};
...
module.exports = {
    ...
    createFluidT1LiquidationProtectionL2Strategy,
    createFluidT1FLLiquidationProtectionL2Strategy,
